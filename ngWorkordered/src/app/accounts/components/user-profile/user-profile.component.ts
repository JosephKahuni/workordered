...
export class UserProfileComponent implements OnInit, OnDestroy {
  ...
  changePrimaryPhoneNumber(): void {
    this.router.navigate(['accounts/changePrimaryPhoneNumber']);
  }

  changeSecondaryPhoneNumber(): void {
    this.router.navigate(['accounts/changeSecondaryPhoneNumber']);
  }


  addSecondaryPhoneNumber(): void {
    this.router.navigate(['accounts/addSecondaryPhoneNumber']);
  }
